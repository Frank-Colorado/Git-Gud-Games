...
export type UpdateUserMutation = { __typename?: 'Mutation', updateUser: { __typename?: 'User', _id: string, username: string, avatar?: string | null, bio: string, gameLibrary: Array<{ __typename?: 'GameObject', id: number, name: string, image: string }> } };
